    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <p className="text-muted text-sm mb-4">Connect your Put.io account to stream media.</p>
          <a
            href="/settings"
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col">
      <VideoPlayer
        ...
        subtitlesUrl={file.hasSubtitles ? `/api/putio/stream?fileId=${file.putioFileId}&subtitles=true` : undefined}
      />
    </div>
  );
}
